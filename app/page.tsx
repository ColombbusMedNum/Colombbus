  ...
  },
  {
    ...
    children: [
      ...
      { id: "actions-coll", kind: "leaf", accent: "teal", icon: UserGroupIcon, title: "Cafés Numériques", subtitle: "Saisir les bilans simplifiés d'ateliers", actionId: "home_nav_actions_coll", href: "/mediation/actions-collectives" },
      {
        ...
        children: [
          { id: "digitalup-inscription", kind: "leaf", accent: "orange", icon: DocumentPlusIcon, title: "Formulaire d'inscription Digital'UP", subtitle: "Inscription au programme Digital'UP", actionId: "home_nav_digitalup_inscription", href: "/mediation/actions-collectives/inscription/digital-up" },
          { id: "digitalup-reponses", kind: "leaf", accent: "teal", icon: ClipboardDocumentCheckIcon, title: "Réponses au formulaire Digital'UP", subtitle: "Préinscriptions reçues au programme Digital'UP", actionId: "home_nav_digitalup_reponses", href: "/mediation/actions-collectives/reponses/digital-up" },
          { id: "digitalup-suivi", kind: "leaf", accent: "orange", icon: UsersIcon, title: "Suivi de recrutement", subtitle: "Apprenant·e·s retenu·e·s, session par session", actionId: "home_nav_digitalup_suivi", href: "/mediation/actions-collectives/reponses/digital-up/suivi-recrutement" },
          { id: "digitalup-stats", kind: "leaf", accent: "teal", icon: ChartPieIcon, title: "Statistiques Digital'UP", subtitle: "Sexe, âge, diplôme et taux de présence par session", actionId: "home_nav_digitalup_stats", href: "/mediation/actions-collectives/reponses/digital-up/statistiques" },
    ...
    children: [
      {
        ...
        children: [
          { id: "nkup-inscription", kind: "leaf", accent: "teal", icon: DocumentPlusIcon, title: "Formulaire d'inscription Numérik'UP", subtitle: "Inscription au programme Numérik'UP", actionId: "home_nav_nkup_inscription", href: "/mediation/actions-collectives/inscription/numerik-up" },
          { id: "nkup-reponses", kind: "leaf", accent: "orange", icon: ClipboardDocumentCheckIcon, title: "Réponses au formulaire Numérik'UP", subtitle: "Préinscriptions reçues au programme Numérik'UP", actionId: "home_nav_nkup_reponses", href: "/mediation/actions-collectives/reponses/numerik-up" },
          { id: "nkup-suivi", kind: "leaf", accent: "teal", icon: UsersIcon, title: "Suivi de recrutement", subtitle: "Apprenant·e·s retenu·e·s, session par session", actionId: "home_nav_nkup_suivi", href: "/mediation/actions-collectives/reponses/numerik-up/suivi-recrutement" },
          { id: "nkup-apprenants", kind: "leaf", accent: "orange", icon: UserGroupIcon, title: "Apprenant·e·s", subtitle: "Suivi pédagogique et administratif, session par session", actionId: "home_nav_nkup_apprenants", href: "/mediation/actions-collectives/reponses/numerik-up/apprenants" },
          { id: "nkup-stats", kind: "leaf", accent: "orange", icon: ChartPieIcon, title: "Statistiques Numérik'UP", subtitle: "Sexe, âge, diplôme et taux de présence par session", actionId: "home_nav_nkup_stats", href: "/mediation/actions-collectives/reponses/numerik-up/statistiques" },
          { id: "nkup-parametres", kind: "leaf", accent: "teal", icon: Cog6ToothIcon, title: "Paramètres Numérik'UP", subtitle: "Gérer les parcours, territoires et sessions", actionId: "home_nav_nkup_parametres", href: "/mediation/actions-collectives/inscription/numerik-up/parametres" },
        ],
      },
    ],
  },
    ...
    children: [
      {
        ...
        title: "NUMERIK PRO", subtitle: "Préinscriptions, apprenant·e·s et suivi NUMERIK PRO",
