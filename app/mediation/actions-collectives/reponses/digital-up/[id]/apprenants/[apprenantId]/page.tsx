...
// Évolution) — la fiche se contente donc de tout relire ici, sans requête
// supplémentaire.
interface Inscription {
  ...
  // Évolution (+ journal des absences, encore intégré à la même page côté UI)
...
export default function FicheApprenantDigitalUpPage() {
            ...
            <div className="space-y-3">
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  <Puce actif={i.E2C_CW} label="CW" />
                  <Puce actif={i.E2C_CV} label="CV" />
                  <Puce actif={i.E2C_CE} label="CE" />
                  <Puce actif={i.E2C_LinkedIn} label="LinkedIn" />
                </div>
              </div>
              <div>
                <div className="text-[10px] font-bold uppercase tracking-wider text-[#404040]/50 mb-1.5">Diplôme intermédiaire (DI)</div>
                <div className="flex flex-wrap gap-2">
                  <Puce actif={i.DI_0} label="0" />
                  <Puce actif={i.DI_1} label="1" />
                  <Puce actif={i.DI_D} label="D" />
                </div>
              </div>
              <div>
                <div className="text-[10px] font-bold uppercase tracking-wider text-[#404040]/50 mb-1.5">Productions rendues</div>
                <div className="grid grid-cols-3 gap-3">
                  <Champ label={`GR${i.Production_GR_Rendu ? " ✔" : ""}`} valeur={i.Production_GR_Nombre} />
                  <Champ label={`GD${i.Production_GD_Rendu ? " ✔" : ""}`} valeur={i.Production_GD_Nombre} />
                  <Champ label={`VSC${i.Production_VSC_Rendu ? " ✔" : ""}`} valeur={i.Production_VSC_Nombre} />
                </div>
              </div>
            </div>
          </Section>
