...
export default function ApprenantsDigitalUpSessionPage() {
  ...
  // paramètres — affiché dans le sélecteur de session à la place de la date
  // en toutes lettres.
  ...
  // date si aucun code n'a encore été généré.
  ...
  const changerSession = (nouvelleSession: string) => {
    router.push(`/mediation/actions-collectives/reponses/digital-up/${encodeURIComponent(nouvelleSession)}/apprenants`);
  };
      ...
      <div className="max-w-[100rem] mx-auto relative z-10 space-y-6">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center pb-4 border-b border-[#404040]/10 gap-4">
          ...
          <div className="flex flex-wrap items-center gap-2.5 w-full lg:w-auto">
            ...
            {sessionsDuTerritoire.length > 0 && (
              ...
              >
                {!sessionsDuTerritoire.includes(sessionId) && sessionId && (
                  <option value={sessionId}>{codeDeSession(sessionId)}</option>
                )}
            ...
            <Link
              href={`/mediation/actions-collectives/reponses/digital-up/${encodeURIComponent(sessionId)}/evolution`}
            ...
            <Link
              href={`/mediation/actions-collectives/reponses/digital-up/${encodeURIComponent(sessionId)}`}
              className="flex items-center gap-2 bg-white hover:bg-[#005259] hover:text-white border border-[#404040]/10 px-3.5 py-2 rounded-xl text-[#005259] transition-all text-xs font-bold uppercase tracking-wider shadow-sm"
            >
            ...
            <table className="border-collapse text-xs">
              ...
              <tbody className="divide-y divide-[#404040]/5">
                {apprenantsFiltres.length > 0 ? (
                    ...
                    return (
                      <tr key={i.id} className="hover:bg-[#F3F3F2]/60 transition-colors align-top">
                        ...
                        <td className="px-3 py-2 whitespace-nowrap font-bold text-[#005259]">
                          <Link href={`/mediation/actions-collectives/reponses/digital-up/${encodeURIComponent(sessionId)}/apprenants/${i.id}`} className="hover:text-[#EA601F] hover:underline transition-colors">
                            {i.Prénom || "—"}
                          </Link>
                        </td>
                  ...
                  <tr>
                    <td colSpan={18} className="px-6 py-16 text-center text-xs font-bold uppercase tracking-wider text-[#404040]/60">
