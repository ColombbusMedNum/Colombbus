          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-xl md:text-3xl font-bold uppercase text-[#005259] tracking-tight">
                Statistiques <span className="text-[#EA601F] font-semibold">PRFE</span>
              </h1>
              <p className="text-xs text-[#404040]/70 mt-0.5 font-medium">
                Toutes les actions PRFE de {annee} — {preinscriptionsAnnee.length} préinscription{preinscriptionsAnnee.length > 1 ? "s" : ""}
              </p>
            </div>
          </div>
