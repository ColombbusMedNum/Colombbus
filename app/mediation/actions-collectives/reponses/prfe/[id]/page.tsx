...
// propres à PRFE (renseignés par l'équipe à la main, d'après la
...
interface Inscription {
  ...
  Session?: string;
  // Coché sur /reponses/prfe : détermine si la personne apparaît
  // ici, sur la page de suivi détaillé de sa session.
  Suivi_Recrutement?: boolean;
  // Champs de suivi de recrutement propres à PRFE, absents du
...
// Duplicata de reponses/prfe, paramétré par un identifiant de
...
export default function ReponsesPrfeSessionPage() {
  ...
  const changerSession = (nouvelleSession: string) => {
    router.push(`/mediation/actions-collectives/reponses/prfe/${encodeURIComponent(nouvelleSession)}`);
  };
