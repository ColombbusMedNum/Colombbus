...
// Digital Up 96H Tech" (formulaire papier fourni). Les champs déjà présents sur
...
// Numérik'UP, DIGITAL UP 96H) : état local uniquement, perdue en quittant la page.
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white text-black p-6 md:p-[1.8cm] print:p-0 rounded-2xl print:rounded-none shadow-sm print:shadow-none mx-auto w-full max-w-4xl space-y-3">
        ...
        <div className="bg-[#005259] text-white text-center py-4 rounded-xl print:rounded-none">
          ...
          <p className="text-sm font-medium">{i.Parcours || "Digital Up"}</p>
        </div>
        ...
        <SectionPDF titre="Votre future expérience professionnelle">
          ...
          <div>
            <CocherChoixMultiple
              label={`Quelles compétences souhaitez-vous renforcer ou acquérir dans le cadre de ${i.Parcours || "Digital Up"} ?`}
              options={[
        ...
        <SectionPDF titre="Que visez-vous à la sortie de la formation Digital Up 96H ?">
          <BlocObjectif
          ...
          <BlocObjectif
            ...
            question={`Pouvez-vous décrire brièvement votre projet professionnel et comment ${i.Parcours || "Digital Up"} pourrait vous y aider ?`}
        ...
        <div className="pt-4 border-t border-[#404040]/15 text-[9px] text-[#404040]/70 print:text-black leading-relaxed space-y-2 break-inside-avoid-page">
          ...
          <p className="text-center text-[10px] font-bold uppercase tracking-widest text-[#EA601F] print:text-black pt-2">{i.Parcours || "Digital Up"}</p>
        </div>
      </div>
