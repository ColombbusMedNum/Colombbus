...
// Statistiques annuelles de toutes les actions DIGITAL UP 96H : tous
// territoires confondus, puis détaillées par territoire.
export default function StatistiquesDigitalUpProPage() {
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-xl md:text-3xl font-bold uppercase text-[#005259] tracking-tight">
                Statistiques <span className="text-[#EA601F] font-semibold">DIGITAL UP 96H</span>
              </h1>
              <p className="text-xs text-[#404040]/70 mt-0.5 font-medium">
                Toutes les actions DIGITAL UP 96H de {annee} — {preinscriptionsAnnee.length} préinscription{preinscriptionsAnnee.length > 1 ? "s" : ""}
              </p>
            </div>
          </div>
