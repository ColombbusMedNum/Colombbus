...
// Reprend les intitulés réels observés dans les réponses Digital Up 96H —
...
export default function FormulaireDigitalUpProPage() {
  ...
  // (voir .../digital-up-pro/parametres, réservée à l'admin) — ce
  ...
  // choix de session (voir .../digital-up-pro/parametres pour la gestion).
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.error("Erreur lors de l'enregistrement de l'inscription DIGITAL UP 96H :", error);
    ...
    <main className={`${quicksand.className} min-h-screen bg-[#F3F3F2] text-[#404040] p-4 md:p-8 font-medium antialiased relative overflow-hidden`}>
      ...
      <div className="max-w-3xl mx-auto relative z-10 space-y-6">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-xl md:text-3xl font-bold uppercase text-[#005259] tracking-tight">
                Formulaire <span className="text-[#EA601F] font-semibold">DIGITAL UP 96H</span>
              </h1>
              <p className="text-xs text-[#404040]/70 mt-0.5 font-medium">
                Pré-inscription au parcours DIGITAL UP 96H
              </p>
            </div>
          </div>
        ...
        <div className="bg-[#88ACEA]/10 border border-[#88ACEA]/40 rounded-xl p-3 text-[11px] text-[#404040]">
          Les données recueillies dans ce formulaire font l'objet d'un traitement informatique destiné à l'inscription à l'action Digital Up 96H organisée par l'association Colombbus, en conformité avec la loi RGPD 2018.
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="bg-white border border-[#404040]/10 rounded-2xl p-5 shadow-sm space-y-4">
            ...
            <div>
              <label className={labelClass}>Comment avez-vous connu l'action Digital Up 96H ?</label>
            ...
            <div>
              <label className={labelClass}>De quelle manière la formation Digital Up 96H peut vous permettre d'y accéder ?</label>
            ...
            <label className="flex items-start gap-2.5 text-xs text-[#404040] cursor-pointer">
              <input
                ...
                className="mt-0.5 w-4 h-4 accent-[#005259] cursor-pointer"
              />
              <span>J'accepte que mes coordonnées soient partagées avec l'équipe Digital Up 96H et le bénéficiaire dans le cadre de la simulation. *</span>
            </label>
