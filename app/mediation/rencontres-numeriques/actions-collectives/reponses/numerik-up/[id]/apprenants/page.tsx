                    ...
                    return (
                      <tr key={i.id} className="hover:bg-[#F3F3F2]/60 transition-colors align-top">
                        ...
                        <td className="px-3 py-2 whitespace-nowrap font-bold text-[#005259]">
                          <Link href={`/mediation/rencontres-numeriques/actions-collectives/reponses/numerik-up/${encodeURIComponent(sessionId)}/apprenants/${i.id}`} className="hover:text-[#EA601F] hover:underline transition-colors">
                            {i.Prénom || "—"}
                          </Link>
                        </td>
