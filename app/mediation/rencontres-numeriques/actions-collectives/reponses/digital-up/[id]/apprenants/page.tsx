...
export default function ApprenantsDigitalUpSessionPage() {
  ...
  const changerSession = (nouvelleSession: string) => {
    router.push(`/mediation/rencontres-numeriques/actions-collectives/reponses/digital-up/${encodeURIComponent(nouvelleSession)}/apprenants`);
  };
      ...
      <div className="max-w-[100rem] mx-auto relative z-10 space-y-6">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center pb-4 border-b border-[#404040]/10 gap-4">
          ...
          <div className="flex flex-wrap items-center gap-2.5 w-full lg:w-auto">
            ...
            <Link
              href={`/mediation/rencontres-numeriques/actions-collectives/reponses/digital-up/${encodeURIComponent(sessionId)}/evolution`}
            ...
            <Link
              href={`/mediation/rencontres-numeriques/actions-collectives/reponses/digital-up/${encodeURIComponent(sessionId)}`}
              className="flex items-center gap-2 bg-white hover:bg-[#005259] hover:text-white border border-[#404040]/10 px-3.5 py-2 rounded-xl text-[#005259] transition-all text-xs font-bold uppercase tracking-wider shadow-sm"
            >
