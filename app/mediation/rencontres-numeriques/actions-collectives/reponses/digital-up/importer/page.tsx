...
export default function ImporterDigitalUpPage() {
    ...
    try {
      ...
      for (let i = 0; i < lignesParsees.length; i += taillePaquet) {
        ...
        paquet.forEach((l) => {
          ...
          const ref = doc(collection(db, "inscriptions_digitalup"));
          batch.set(ref, {
            ...donnees,
      ...
      console.error("Erreur lors de l'import des préinscriptions Digital'UP :", error);
