    ...
    <main className={`${quicksand.className} min-h-screen bg-[#F3F3F2] text-[#404040] p-4 md:p-8 font-medium antialiased relative overflow-hidden`}>
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="flex justify-between items-center mb-6">
          <Link href="/liste-beneficiaires" className="inline-flex items-center gap-2 text-[#404040]/70 hover:text-[#005259] transition-colors group">
            <ChevronLeftIcon className="w-4 h-4 group-hover:-translate-x-1 transition-transform" />
            <span className="text-xs font-bold uppercase tracking-wider">Retour à la liste</span>
          </Link>
          
          <div className="flex items-center gap-2">
            <Link href="/suresnes" className="inline-flex items-center gap-2 bg-white border border-[#404040]/10 hover:border-[#005259] hover:bg-[#005259] hover:text-white px-3.5 py-2 rounded-xl text-xs font-bold uppercase tracking-wider text-[#005259] transition-all shadow-sm">
              <CalendarDaysIcon className="w-4 h-4 text-[#EA601F]" />
              <span>Agenda Suresnes</span>
            </Link>
            <Link href="/equipe" className="inline-flex items-center gap-2 bg-white border border-[#404040]/10 hover:border-[#005259] hover:bg-[#005259] hover:text-white px-3.5 py-2 rounded-xl text-xs font-bold uppercase tracking-wider text-[#005259] transition-all shadow-sm">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1 space-y-4">
            ...
            <section className="bg-white border border-[#404040]/10 rounded-2xl p-5 shadow-sm">
              ...
              <Link href={`/diagnosticform?id=${userId}`} className="mt-4 w-full inline-flex items-center justify-center gap-2 bg-[#005259] hover:bg-[#EA601F] text-white font-bold py-2.5 rounded-xl text-xs uppercase tracking-wider transition-all shadow-md active:scale-95">
                <PlusCircleIcon className="w-4 h-4" />
