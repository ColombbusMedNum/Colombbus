                              ...
                              <div key={c.id} className={`grid grid-cols-1 xl:grid-cols-12 items-center gap-4 p-3 rounded-xl border transition-all ${isOrphan ? 'bg-[#EF736A]/10 border-[#EF736A]/30' : 'bg-[#F3F3F2]/50 border-[#404040]/10 hover:border-[#005259]/30 hover:bg-[#F3F3F2]'}`}>
                                ...
                                <div className="xl:col-span-1.5 flex items-center justify-start xl:justify-center">
                                  {trendBesoinDiagnostic ? (
                                    <Link href={`/liste-beneficiaires/${bTrouve.id}`} className="inline-flex items-center gap-1.5 bg-[#EA601F] hover:bg-[#EF736A] text-white px-2.5 py-1 rounded-xl text-[10px] font-bold uppercase tracking-wider transition-all cursor-pointer shadow-sm group w-full justify-center">
