...
const DETAILED_PAGES: PageEntry[] = [
  {
    ...
    actions: [
      ...
      { id: "home_nav_nkpro_tech", nom: "Badge NKPRO Tech", type: "button", description: "Déploie le dossier NKPRO Tech (inscription, réponses, suivi) depuis Insertion Professionnelle" },
      { id: "home_nav_nkpro_inscription", nom: "Lien Formulaire d'inscription Numérik'UP Pro", type: "Link", description: "Accède au formulaire d'inscription Numérik'UP Pro depuis Insertion Professionnelle" },
      { id: "home_nav_nkpro_reponses", nom: "Lien Réponses au formulaire Numérik'UP Pro", type: "Link", description: "Accède aux préinscriptions Numérik'UP Pro depuis Insertion Professionnelle" },
      { id: "home_nav_nkpro_suivi", nom: "Lien Suivi de recrutement Numérik'UP Pro", type: "Link", description: "Redirige vers la première session de suivi de recrutement Numérik'UP Pro" },
      { id: "home_nav_nkpro_stats", nom: "Lien Statistiques Numérik'UP Pro", type: "Link", description: "Accède aux statistiques Numérik'UP Pro depuis Insertion Professionnelle" },
      { id: "home_nav_nkpro_parametres", nom: "Lien Paramètres Numérik'UP Pro", type: "Link", description: "Accède à la gestion des parcours/territoires/sessions Numérik'UP Pro — réservé à l'admin, comme le bouton \"Gérer\" du formulaire" },
...
export const DEFAULT_PERMISSIONS: Record<string, Record<string, boolean>> = {
  ...
  coordinateur: {
    ...
    home_logout: true, home_folder_rencontres: true, home_folder_stats: true, home_nav_liste_benef: true,
    home_folder_beneficiaires: true, home_folder_bilans: true, home_folder_lieux: true,
    home_nav_fiche_bilan: true, home_nav_bilan_tech: true, home_nav_rdv_par_lieu: true, home_nav_ajouter_lieu: true, home_nav_equipe: true, home_nav_participants: true,
    home_nav_collectes: true, home_nav_agenda_suresnes: true, home_nav_emargement_docs: true,
