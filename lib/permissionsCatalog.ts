...
const DETAILED_PAGES: PageEntry[] = [
  {
    ...
    actions: [
      ...
      { id: "home_nav_digital_up", nom: "Lien Digital'UP", type: "Link", description: "Accède au programme Digital'UP depuis Inclusion Numérique" },
      ...
      { id: "home_nav_nkpro_tech", nom: "Lien NKPRO Tech", type: "Link", description: "Accède au programme Numérik'UP Pro depuis Insertion Professionnelle" },
      { id: "home_nav_programmes_inscriptions", nom: "Lien Programmes & Inscriptions", type: "Link", description: "Accède au hub Actions Collectives (inscriptions, réponses, programmes) depuis Inclusion Numérique, Découvertes Métiers et Insertion Professionnelle" },
...
export const DEFAULT_PERMISSIONS: Record<string, Record<string, boolean>> = {
  ...
  mediateur: {
    ...
    home_folder_inclusion_numerique: true, home_folder_rencontres_numeriques: true, home_nav_digital_up: true,
    home_folder_decouvertes_metiers: true, home_nav_nkup: true, home_nav_nkup_inscription: true, home_nav_nkup_reponses: true, home_nav_nkup_suivi: true, home_folder_insertion_pro: true, home_nav_nkpro_tech: true, home_nav_programmes_inscriptions: true,
