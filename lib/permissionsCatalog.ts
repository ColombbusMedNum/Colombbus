...
const DETAILED_PAGES: PageEntry[] = [
  {
    ...
    actions: [
      ...
      { id: "home_nav_actions_coll", nom: "Lien Cafés Numériques", type: "Link", description: "Accède à la saisie d'ateliers de groupe" },
      ...
      { id: "home_nav_bibliotheque_logos", nom: "Lien Bibliothèque Logos", type: "Link", description: "Accède à la bibliothèque de logos partenaires depuis l'accueil" },
      { id: "home_nav_guide", nom: "Lien Mode d'emploi", type: "Link", description: "Accède au mode d'emploi complet de la plateforme" },
      { id: "home_folder_inclusion_numerique", nom: "Badge Inclusion Numérique", type: "button", description: "Déploie le dossier Inclusion Numérique" },
      { id: "home_folder_rencontres_numeriques", nom: "Badge Rencontres Numériques", type: "button", description: "Déploie le dossier Rencontres Numériques (dans Inclusion Numérique)" },
      { id: "home_nav_digital_up", nom: "Badge Digital'UP", type: "button", description: "Déploie le dossier Digital'UP (inscription, réponses, suivi) depuis Inclusion Numérique" },
      { id: "home_nav_digitalup_inscription", nom: "Lien Formulaire d'inscription Digital'UP", type: "Link", description: "Accède au formulaire d'inscription Digital'UP depuis Inclusion Numérique" },
      { id: "home_nav_digitalup_reponses", nom: "Lien Réponses au formulaire Digital'UP", type: "Link", description: "Accède aux préinscriptions Digital'UP depuis Inclusion Numérique" },
      { id: "home_nav_digitalup_suivi", nom: "Lien Suivi de recrutement Digital'UP", type: "Link", description: "Redirige vers la première session de suivi de recrutement Digital'UP" },
      { id: "home_nav_digitalup_stats", nom: "Lien Statistiques Digital'UP", type: "Link", description: "Accède aux statistiques Digital'UP depuis Inclusion Numérique" },
      { id: "home_nav_digitalup_parametres", nom: "Lien Paramètres Digital'UP", type: "Link", description: "Accède à la gestion des parcours/territoires/sessions Digital'UP — réservé à l'admin, comme le bouton \"Gérer\" du formulaire" },
      { id: "home_folder_decouvertes_metiers", nom: "Badge Découvertes Métiers", type: "button", description: "Déploie le dossier Découvertes Métiers" },
      { id: "home_nav_nkup", nom: "Badge NKUP", type: "button", description: "Déploie le dossier NKUP (inscription, réponses, suivi) depuis Découvertes Métiers" },
      { id: "home_nav_nkup_inscription", nom: "Lien Formulaire d'inscription Numérik'UP", type: "Link", description: "Accède au formulaire d'inscription Numérik'UP depuis Découvertes Métiers" },
      { id: "home_nav_nkup_reponses", nom: "Lien Réponses au formulaire Numérik'UP", type: "Link", description: "Accède aux préinscriptions Numérik'UP depuis Découvertes Métiers" },
      { id: "home_nav_nkup_suivi", nom: "Lien Suivi de recrutement", type: "Link", description: "Redirige vers la première session de suivi de recrutement Numérik'UP" },
      { id: "home_nav_nkup_apprenants", nom: "Lien Apprenant·e·s", type: "Link", description: "Redirige vers la première session d'apprenant·e·s Numérik'UP" },
      { id: "home_nav_nkup_stats", nom: "Lien Statistiques Numérik'UP", type: "Link", description: "Accède aux statistiques Numérik'UP depuis Découvertes Métiers" },
      { id: "home_nav_nkup_parametres", nom: "Lien Paramètres Numérik'UP", type: "Link", description: "Accède à la gestion des parcours/territoires/sessions Numérik'UP — réservé à l'admin, comme le bouton \"Gérer\" du formulaire" },
      { id: "home_folder_insertion_pro", nom: "Badge Insertion Professionnelle", type: "button", description: "Déploie le dossier Insertion Professionnelle" },
      { id: "home_nav_nkpro_tech", nom: "Badge NUMERIK PRO", type: "button", description: "Déploie le dossier NUMERIK PRO (inscription, réponses, suivi) depuis Insertion Professionnelle" },
      { id: "home_nav_nkpro_inscription", nom: "Lien Formulaire d'inscription NUMERIK PRO", type: "Link", description: "Accède au formulaire d'inscription NUMERIK PRO depuis Insertion Professionnelle" },
      { id: "home_nav_nkpro_reponses", nom: "Lien Réponses au formulaire NUMERIK PRO", type: "Link", description: "Accède aux préinscriptions NUMERIK PRO depuis Insertion Professionnelle" },
      ...
      { id: "home_nav_nkpro_apprenants", nom: "Lien Apprenant·e·s NUMERIK PRO", type: "Link", description: "Redirige vers la première session d'apprenant·e·s NUMERIK PRO" },
      ...
      { id: "home_nav_duppro_tech", nom: "Badge DIGITAL UP 96H", type: "button", description: "Déploie le dossier DIGITAL UP 96H (inscription, réponses, suivi) depuis Insertion Professionnelle" },
      { id: "home_nav_duppro_formulaires", nom: "Badge Formulaires DIGITAL UP 96H", type: "button", description: "Déploie le dossier Formulaires (inscription, test de langue, Collecte Tech) DIGITAL UP 96H" },
      { id: "home_nav_duppro_inscription", nom: "Lien Formulaire d'inscription DIGITAL UP 96H", type: "Link", description: "Accède au formulaire d'inscription DIGITAL UP 96H depuis Insertion Professionnelle" },
      { id: "home_nav_duppro_test_langue", nom: "Lien Test de langue DIGITAL UP 96H", type: "Link", description: "Accède au lien public et aux résultats du test de langue B1 DIGITAL UP 96H" },
      { id: "home_nav_duppro_collecte_tech", nom: "Lien Diagnostic Collecte Tech DIGITAL UP 96H", type: "Link", description: "Accède au lien public et aux résultats du diagnostic Collecte Tech DIGITAL UP 96H" },
      { id: "home_nav_duppro_reponses", nom: "Lien Réponses au formulaire DIGITAL UP 96H", type: "Link", description: "Accède aux préinscriptions DIGITAL UP 96H depuis Insertion Professionnelle" },
      { id: "home_nav_duppro_suivi", nom: "Lien Suivi de recrutement DIGITAL UP 96H", type: "Link", description: "Redirige vers la première session de suivi de recrutement DIGITAL UP 96H" },
      { id: "home_nav_duppro_apprenants", nom: "Lien Apprenant·e·s DIGITAL UP 96H", type: "Link", description: "Redirige vers la première session d'apprenant·e·s DIGITAL UP 96H" },
      { id: "home_nav_duppro_suivi_administratif", nom: "Lien Suivi administratif DIGITAL UP 96H", type: "Link", description: "Redirige vers la première session de suivi administratif DIGITAL UP 96H" },
      { id: "home_nav_duppro_stats", nom: "Lien Statistiques DIGITAL UP 96H", type: "Link", description: "Accède aux statistiques DIGITAL UP 96H depuis Insertion Professionnelle" },
      { id: "home_nav_duppro_parametres", nom: "Lien Paramètres DIGITAL UP 96H", type: "Link", description: "Accède à la gestion des parcours/territoires/sessions DIGITAL UP 96H — réservé à l'admin, comme le bouton \"Gérer\" du formulaire" },
      { id: "home_nav_prfe_tech", nom: "Badge Préparation Parcours Métiers", type: "button", description: "Déploie le dossier Préparation Parcours Métiers (inscription, réponses, suivi) depuis Insertion Professionnelle" },
      { id: "home_nav_prfe_inscription", nom: "Lien Formulaire d'inscription Préparation Parcours Métiers", type: "Link", description: "Accède au formulaire d'inscription Préparation Parcours Métiers depuis Insertion Professionnelle" },
      { id: "home_nav_prfe_reponses", nom: "Lien Réponses au formulaire Préparation Parcours Métiers", type: "Link", description: "Accède aux préinscriptions Préparation Parcours Métiers depuis Insertion Professionnelle" },
      { id: "home_nav_prfe_suivi", nom: "Lien Suivi de recrutement Préparation Parcours Métiers", type: "Link", description: "Redirige vers la première session de suivi de recrutement Préparation Parcours Métiers" },
      { id: "home_nav_prfe_stats", nom: "Lien Statistiques Préparation Parcours Métiers", type: "Link", description: "Accède aux statistiques Préparation Parcours Métiers depuis Insertion Professionnelle" },
      { id: "home_nav_prfe_parametres", nom: "Lien Paramètres Préparation Parcours Métiers", type: "Link", description: "Accède à la gestion des parcours/territoires/sessions Préparation Parcours Métiers — réservé à l'admin, comme le bouton \"Gérer\" du formulaire" },
      ...
      { id: "home_folder_actions_personnalisees", nom: "Lien Actions personnalisées", type: "Link", description: "Accède à la liste et à la création des actions collectives créées depuis la plateforme (voir /mediation/actions-collectives/creer-action)" },
    ],
  },
  {
  ...
  },
  {
    ...
    actions: [
      ...
      { id: "benef_filter_essonne", nom: "Badge Filtre Essonne", type: "button", description: "Affiche les bénéficiaires dont le code postal commence par 91 (Essonne)" },
      ...
      { id: "benef_nav_suivi_rnd", nom: "Lien Suivi Visites à Domicile (RND)", type: "Link", description: "Accède au suivi des bénéficiaires en visite à domicile depuis la liste des bénéficiaires" },
  ...
  },
  {
    ...
    actions: [
      ...
      { id: "fiche_nav_suivi_collecte", nom: "Lien Suivi Collecte Tech", type: "Link", description: "Accède au suivi Collecte Tech depuis la fiche, si le rattachement principal du bénéficiaire est \"92 - Collecte Tech\"" },
  ...
  },
  {
    ...
    route: "/mediation/actions-collectives",
    filePath: "app/mediation/actions-collectives/page.tsx",
    actions: [
  ...
  },
  {
    ...
    actions: [
      ...
      { id: "suresnes_reassign", nom: "Bouton Réaffecter médiateur", type: "button", description: "Attribue un créneau (orphelin ou non, avec ou sans bénéficiaire déjà inscrit) à un autre membre du staff, ou supprime un créneau déjà affecté (jamais si un usager y est inscrit)" },
      { id: "suresnes_add_creneau", nom: "Bouton Ajouter un créneau", type: "button", description: "Ouvre la modale d'ajout manuel d'un créneau (date, médiateur, horaire) — distinct de la réaffectation/suppression d'un créneau déjà posé" },
...
const PAGE_ONLY_ROUTES: Omit<PageEntry, "actions">[] = [
  ...
  { pageId: "page_access_journal_connexions", pageName: "Journal des Connexions", route: "/mediation/journal-connexions", filePath: "app/mediation/journal-connexions/page.tsx" },
  { pageId: "page_access_signalements", pageName: "Signalements de Bugs", route: "/mediation/signalements", filePath: "app/mediation/signalements/page.tsx" },
  ...
  // Un seul droit partagé pour tout le moteur "actions personnalisées" (voir
  // lib/dynamicActions/) : formulaire public/interne, paramètres, réponses,
  // statistiques, suivi de recrutement, apprenant·e·s, absences, évolution —
  // toutes les routes dynamiques /mediation/actions-collectives/{inscription,
  // reponses}/[slug]/... et /mediation/actions-collectives/creer-action.
  // Pas de permission fine par action créée : qui a ce droit voit tout.
  { pageId: "page_access_action_dynamique", pageName: "Actions personnalisées", route: "/mediation/actions-collectives/creer-action (+ routes dynamiques [slug])", filePath: "app/mediation/actions-collectives/creer-action/page.tsx (et al.)" },
  ...
  { pageId: "page_access_suivi_rnd", pageName: "Suivi Visites à Domicile (RND)", route: "/mediation/rencontres-numeriques/suivi-rnd", filePath: "app/mediation/rencontres-numeriques/suivi-rnd/page.tsx" },
];
...
export const DEFAULT_PERMISSIONS: Record<string, Record<string, boolean>> = {
  ...
  mediateur: {
    page_access_home: true, page_access_login: true, page_access_reset_password: true, page_access_planning: true, page_access_mon_compte: true, page_access_liste_beneficiaires: true, page_access_suivi_rnd: true,
    ...
    home_logout: true, home_folder_rencontres: true, home_folder_stats: true, home_nav_liste_benef: true, home_nav_suivi_rnd: true,
    home_folder_beneficiaires: true, home_folder_bilans: true, home_folder_lieux: true,
    home_nav_fiche_bilan: true, home_nav_bilan_tech: true, home_nav_ajouter_lieu: true, home_nav_equipe: true, home_nav_participants: true, home_nav_bibliotheque_logos: true,
    ...
    home_folder_decouvertes_metiers: true, home_nav_nkup: true, home_nav_nkup_inscription: true, home_nav_nkup_reponses: true, home_nav_nkup_suivi: true, home_nav_nkup_apprenants: true, home_nav_nkup_stats: true, home_folder_insertion_pro: true, home_nav_nkpro_tech: true, home_nav_nkpro_inscription: true, home_nav_nkpro_reponses: true, home_nav_nkpro_suivi: true, home_nav_nkpro_apprenants: true, home_nav_nkpro_stats: true, home_nav_duppro_tech: true, home_nav_duppro_formulaires: true, home_nav_duppro_inscription: true, home_nav_duppro_test_langue: true, home_nav_duppro_collecte_tech: true, home_nav_duppro_reponses: true, home_nav_duppro_suivi: true, home_nav_duppro_apprenants: true, home_nav_duppro_suivi_administratif: true, home_nav_duppro_stats: true, home_nav_prfe_tech: true, home_nav_prfe_inscription: true, home_nav_prfe_reponses: true, home_nav_prfe_suivi: true, home_nav_prfe_stats: true,
    ...
    benef_nav_suresnes_liste: true, benef_nav_suivi_rnd: true,
    ...
    fiche_nav_bilan_tech: true, fiche_nav_agenda_suresnes: true, fiche_nav_suivi_collecte: true,
    ...
    suresnes_filter_today: true, suresnes_month_nav: true, suresnes_reassign: true, suresnes_add_creneau: true, suresnes_create_slot: true,
  ...
  coordinateur: {
    ...
    page_access_bilan_suresnes: true, page_access_volume_horaire: true, page_access_journal_connexions: true, page_access_fiches_bilans: true,
    ...
    page_access_guide: true, home_nav_guide: true,
    home_logout: true, home_folder_rencontres: true, home_folder_stats: true, home_nav_liste_benef: true, home_nav_suivi_rnd: true,
    home_folder_beneficiaires: true, home_folder_bilans: true, home_folder_lieux: true,
    home_nav_fiche_bilan: true, home_nav_bilan_tech: true, home_nav_rdv_par_lieu: true, home_nav_ajouter_lieu: true, home_nav_equipe: true, home_nav_participants: true, home_nav_bibliotheque_logos: true,
    home_nav_collectes: true, home_nav_agenda_suresnes: true, home_nav_emargement_docs: true,
    ...
    benef_action_toggle_blacklist: true, benef_action_open: true, benef_nav_suresnes_liste: true, benef_nav_suivi_rnd: true, benef_nav_bilan_suresnes: true,
  ...
  aci: {
    page_access_home: true, page_access_login: true, page_access_reset_password: true, page_access_planning: true, page_access_mon_compte: true, page_access_liste_beneficiaires: true, page_access_suivi_rnd: true, page_access_suresnes: true,
    ...
    home_logout: true, home_folder_rencontres: true, home_nav_liste_benef: true, home_nav_suivi_rnd: true,
    ...
    benef_nav_suresnes_liste: true, benef_nav_suivi_rnd: true,
    page_access_liste_beneficiaires_suresnes: true, benef_suresnes_filter_trimestre: true,
    suresnes_filter_today: true, suresnes_month_nav: true, suresnes_add_creneau: true,
