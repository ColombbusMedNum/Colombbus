...
const DETAILED_PAGES: PageEntry[] = [
  {
    ...
    actions: [
      ...
      { id: "home_nav_nkup", nom: "Lien NKUP", type: "Link", description: "Accède au suivi Numérik'UP depuis Découvertes Métiers" },
...
export const DEFAULT_PERMISSIONS: Record<string, Record<string, boolean>> = {
  ...
  mediateur: {
    ...
    home_folder_decouvertes_metiers: true, home_nav_nkup: true, home_folder_insertion_pro: true, home_nav_nkpro_tech: true, home_nav_programmes_inscriptions: true,
