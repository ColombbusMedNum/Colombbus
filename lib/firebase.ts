...
// URL de production de l'application (domaine personnalisé cosmos.colombbus.org,
// voir Firebase App Hosting > Domaines) — utilisée comme "continueUrl" des
// e-mails d'authentification Firebase (configuration de compte, réinitialisation
// de mot de passe). Codée en dur plutôt que dérivée de window.location.origin :
...
export const APP_URL = "https://cosmos.colombbus.org";
